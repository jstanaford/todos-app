        ...
        <div class="w-full max-w-5xl px-4 sm:px-6 lg:px-8 py-12 bg-white rounded-lg shadow-xl">
            <div class="text-center">
                <h1 class="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    ...
                    <span class="block text-blue-600 mt-2">Stay Organized & Productive</span>
                </h1>
                ...
                <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                    @auth
                        ...
                        <a href="{{ route('todos.index') }}" class="w-full sm:w-auto px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 md:py-4 md:text-lg md:px-10">
                            Go to Dashboard
                        </a>
                        
                        <form method="POST" action="{{ route('logout') }}" class="w-full sm:w-auto">
                            @csrf
                            <button type="submit" class="w-full px-8 py-3 border border-transparent text-base font-medium rounded-md text-teal-700 bg-teal-100 hover:bg-teal-200 md:py-4 md:text-lg md:px-10">
                                Logout
                            </button>
                        </form>
                    @else
                        <!-- If not logged in -->
                        <a href="{{ route('login') }}" class="w-full sm:w-auto px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 md:py-4 md:text-lg md:px-10">
                            Login
                        </a>
                        
                        <a href="{{ route('register') }}" class="w-full sm:w-auto px-8 py-3 border border-transparent text-base font-medium rounded-md text-teal-700 bg-teal-100 hover:bg-teal-200 md:py-4 md:text-lg md:px-10">
                            Register
                        </a>
        ...
        <div class="w-full max-w-5xl px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <div class="h-12 w-12 bg-blue-100 rounded-md flex items-center justify-center text-blue-600 mb-4">
                ...
                <!-- Feature 2 -->
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <div class="h-12 w-12 bg-teal-100 rounded-md flex items-center justify-center text-teal-600 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <footer class="w-full py-6">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <p class="text-center text-base text-gray-500">
                    &copy; {{ date('Y') }} Todo List Scheduler. Built with ❤️ by <a href="https://jstanaford.github.io/" class="text-blue-600 hover:text-blue-700">Jacob Stanford</a>
                </p>
            </div>
        </footer>
    </div>
