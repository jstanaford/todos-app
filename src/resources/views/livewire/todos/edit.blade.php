                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form wire:submit.prevent="update">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea wire:model="details" id="details" name="details" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" rows="3"></textarea>
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                <input wire:model.live="recurring" id="recurring" type="checkbox" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        ...
                        <div class="mb-4">
                            ...
                            <select wire:model="recurring_schedule" id="recurring_schedule" name="recurring_schedule" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        ...
                        <div class="mb-4">
                            ...
                            <select wire:model="category_id" id="category_id" name="category_id" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
